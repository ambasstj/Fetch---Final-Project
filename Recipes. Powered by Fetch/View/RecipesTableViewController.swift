...
class RecipesTableViewController: UIViewController {
    ...
    var recipeCardVC: RecipeCardController?
    var mealPH = [Meals]()
    ...
    override func viewDidLoad() {
        ...
        tableViewOutlet.register(UINib(
            nibName: "DishCell",
            bundle: nil),
            forCellReuseIdentifier: K.reusableCell)
...
as! DishCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        ...
        if segue.identifier == K.Segues.loadedCard {
            let destinationVC = segue.destination as! RecipeCardController
            recipeCardVC = destinationVC
        }
    }
}

extension RecipesTableViewController: NetworkRequestsDelegate {
